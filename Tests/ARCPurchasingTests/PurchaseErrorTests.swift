...
struct PurchaseErrorTests {
    ...
    @Test("notConfigured has correct description") func notConfigured_hasCorrectDescription() {
    ...
    @Test("networkError includes reason") func networkError_includesReason() {
    ...
    @Test("Network errors are retryable") func networkErrors_areRetryable() {
    ...
    @Test("Network error has recovery suggestion") func networkError_hasRecoverySuggestion() {
        let error = PurchaseError.networkError("test")
        #expect(error.recoverySuggestion != nil)
        #expect(error.recoverySuggestion?.contains("internet connection") == true)
    }

    @Test("purchaseNotAllowed has recovery suggestion") func purchaseNotAllowed_hasRecoverySuggestion() {
    ...
    @Test("PurchaseError equality works correctly") func purchaseError_equalityWorks() {
